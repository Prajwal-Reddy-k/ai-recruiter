...
public interface IJobPostingService
{
    ...
    Task<JobPostingDto?> GetByIdAsync(int id, string? viewerKey, int? viewerUserId, CancellationToken ct = default);
    ...
    Task ReportAsync(int userId, int jobId, string reason, CancellationToken ct = default);
}
