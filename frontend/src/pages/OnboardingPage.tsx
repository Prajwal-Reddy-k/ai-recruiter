...
import { getMyDetails, getOnboardingStatus, updateMyDetails, upsertOnboarding } from "../api/recruiters";
...
function YourDetailsCard() {
  ...
  return (
    <Card className="ui-card-padded" style={{ marginBottom: "1.5rem" }}>
      ...
      <p className="hint" style={{ marginBottom: "1rem" }}>Your personal name and phone number — separate from your company profile below.</p>
